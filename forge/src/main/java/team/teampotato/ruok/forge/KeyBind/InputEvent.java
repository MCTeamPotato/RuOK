...
public class InputEvent {
    ...
    private static void handleKeyPress(@NotNull KeyBinding key, int step, String messageKey) {
        if (key.wasPressed()) {
            int currentValue;
            int newValue;
    ...
    private static void sendMessage(String messageKey) {
        if (minecraftClient.player != null) {
            minecraftClient.player.sendMessage(Text.of(I18n.translate(messageKey)),false);
        }
    }
}
