package team.teampotato.ruok.fabric.config;
...
public class RuOKConfig implements ConfigData {
    ...
    public int MaxDropItemStack = 64;
    public int MediumDropItemStack = 48;
    public int LowDropItemStack = 16;
    public int HighDropItemStack = 32;
