...
public class QualityUtil {
    ...
    static {
        QUALITY_SETTINGS_MAP.put(QualityMode.ULTRA, new QualitySettings(Weather.NORMAL, true, 20, false, ParticlesMode.ALL, GraphicsMode.FABULOUS, true, CloudRenderMode.FANCY, true, 1000, 1000, 500));
        QUALITY_SETTINGS_MAP.put(QualityMode.HIGH, new QualitySettings(Weather.NORMAL, true, 16, true, ParticlesMode.MINIMAL, GraphicsMode.FANCY, true, CloudRenderMode.FANCY, true, 512, 1000, 256));
        QUALITY_SETTINGS_MAP.put(QualityMode.NORMAL, new QualitySettings(Weather.NORMAL, true, 12, true, ParticlesMode.ALL, GraphicsMode.FABULOUS, true, CloudRenderMode.FAST, true, 256, 512, 128));
        QUALITY_SETTINGS_MAP.put(QualityMode.LOW, new QualitySettings(Weather.LOW, true, 4, true, ParticlesMode.MINIMAL, GraphicsMode.FAST, true, CloudRenderMode.OFF, false, 128, 256, 96));
    ...
    private record QualitySettings(Weather weather, boolean renderTNTExplosions, int viewDistance, boolean vsync,
                                   ParticlesMode particlesMode, GraphicsMode graphicsMode, boolean ao,
